...
import ClientDashboardReplica from './pages/ClientDashboardReplica';
import BookSession from './pages/BookSession';
import ClientSettingsPage from './pages/ClientSettingsPage';

import TherapistMainLayout from './pages/therapist-portal/TherapistMainLayout';
import TherapistPortalWrapper from './pages/therapist-portal/TherapistPortalWrapper';
...
import AdminClientAssignmentPage from './pages/AdminClientAssignmentPage';
...
const MainLayout: React.FC = () => {
  ...
  const showNewsletter = !hideOnPaths.includes(location.pathname) && !location.pathname.startsWith('/therapist-portal/');

  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-grow">
        <TherapistPortalWrapper>
          <Outlet />
        </TherapistPortalWrapper>
      </main>
      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route element={<MainLayout />}>
            ...
            <Route path="/client/schedule" element={<SchedulePage />} />
            <Route path="/bookings" element={<SchedulePage />} />
            <Route path="/client/dashboard" element={<ClientDashboardReplica />} />
            <Route path="/book" element={<BookSession />} />

            {/* Therapist Portal Routes - with Header and Footer */}
          ...
          <Route path="/admin/therapist-approvals" element={<AdminTherapistApprovalsPage />} />
          <Route path="/admin/client-assignment" element={<AdminClientAssignmentPage />} />
          <Route path="/admin/clients" element={<Navigate to="/admin/client-assignment" replace />} />
          <Route path="/admin/therapists" element={<Navigate to="/admin/client-assignment" replace />} />
