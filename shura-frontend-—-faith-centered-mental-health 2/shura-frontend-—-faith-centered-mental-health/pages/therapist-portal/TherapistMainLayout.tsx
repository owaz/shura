...
const TherapistMainLayout: React.FC = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            {/* Portal with Sidebar */}
            <div className="flex flex-1 bg-sand">
                {/* Top Navigation Bar for Portal */}
                <div className="fixed md:hidden top-16 left-0 right-0 bg-white border-b border-sand z-30 p-4 flex items-center">
                    {!sidebarOpen && (
                        <button 
                ...
                {/* Sidebar */}
                <aside className={`${sidebarOpen ? 'w-64' : 'w-0'} hidden md:flex bg-brown-soft text-ivory flex-col p-4 shadow-lg overflow-hidden md:w-64 flex-shrink-0 fixed md:relative h-full md:h-auto mt-16 md:mt-0 z-40 md:z-0`}>
                    ...
                    <nav className="flex-grow">
                        <ul className="space-y-2">
                            <li className="mb-6 pb-6 border-b border-ivory/20">
                                <p className="text-xs font-semibold text-ivory/60 uppercase mb-3">Portal</p>
                            </li>
                            <li>
                            ...
                            <li className="mt-6 pt-6 border-t border-ivory/20">
                                <p className="text-xs font-semibold text-ivory/60 uppercase mb-3">Website</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <NavLink to="/therapists" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}>
                                    <span>Therapists</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/shura-hub" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}>
                                    <span>Shura Hub</span>
                                </NavLink>
                            </li>
                            <li>
                ...
                {/* Main Content */}
                <div className="flex-1 flex flex-col overflow-hidden md:ml-0 mt-20 md:mt-0">
...
export default TherapistMainLayout;
