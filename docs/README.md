...
- [Email Phase 0 summary](architecture/email-phase-0-summary.md): preparation and decision gates completion report; 4 of 5 gates complete; identifies blocking dependencies; roadmap for Phase 1/2/3; stakeholder responsibilities.
