  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-brown-dark mb-4" style={{textShadow: '1px 1px 3px rgba(253, 251, 245, 0.7)'}}>The Shura Hub</h1>
        <p className="text-lg text-brown-dark max-w-3xl mx-auto" style={{textShadow: '1px 1px 3px rgba(253, 251, 245, 0.7)'}}>A curated collection of resources to support your journey towards mental and spiritual balance.</p>
      </div>
    </section>
          ...
          {tabs.map(tab => (
            <button
              ...
              className={`px-4 sm:px-8 py-3 text-lg font-semibold transition-colors duration-300 -mb-px
                ${activeTab === tab ? 'border-b-2 border-brown-soft text-brown-soft' : 'text-taupe hover:text-brown-soft'}`}
            >
              {tab}
            </button>
          ))}
