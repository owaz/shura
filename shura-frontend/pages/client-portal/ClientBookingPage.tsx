    ...
    <div className="mx-auto max-w-4xl">
      ...
      <PortalCard>
        ...
        {step === 3 && <div className="mt-5">
          ...
          {availabilityLoading && <div className="mt-5 space-y-3" role="status"><span className="sr-only">Loading live availability</span><div className="h-12 animate-pulse rounded-xl bg-sand motion-reduce:animate-none" /><div className="h-32 animate-pulse rounded-xl bg-sand motion-reduce:animate-none" /></div>}
