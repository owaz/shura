...
const TherapistApplyStatusPage: React.FC = () => (
  <div className="min-h-screen bg-cream flex items-center justify-center p-6">
    <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg p-10 text-center">
      ...
      <h1 className="text-3xl font-serif font-bold text-brown-dark mb-3">Therapist Account Status</h1>
      <p className="text-brown-soft text-lg">
        Your account is not active yet. If your application is under review or suspended, please contact support for the next update.
      </p>
    </div>
  </div>
);

export default TherapistApplyStatusPage;
